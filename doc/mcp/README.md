...
<p align="center">
  <img src="https://mintcdn.com/mcp/bEUxYpZqie0DsluH/images/mcp-simple-diagram.png?fit=max&auto=format&n=bEUxYpZqie0DsluH&q=85&s=35268aa0ad50b8c385913810e7604550" width="600" alt="MCP simple diagram">
</p>
...
* [Build servers](https://modelcontextprotocol.io/docs/develop/build-server) - Create MCP servers to expose your data and tools.
* [Build clients](https://modelcontextprotocol.io/docs/develop/build-client) - Develop applications that connect to MCP servers.
